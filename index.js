...
const TOKEN = "7364379511:AAHrN32dJ0mc734pvGLX1pOYFI_ULG7xzpg";
...
bot.onText(/start|game/, (msg) => {
	...
	const imageUrl = "https://storage.yobimind.com/genify-studio/fallio/character_dragon.png"; // URL to the image
		...
		reply_markup: {
            inline_keyboard: [
                [{
                    text: 'Play Game Here',
                     web_app: {
				     url: "https://thaonm0501.github.io/tele-dino-default/"
					}
                }]
            ]
        }
